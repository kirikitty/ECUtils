...
#import "RFNibUtil.h"
#import "RFBlockActionSheet.h"
#import "RFBlockImagePickerViewController.h"

typedef NS_ENUM(NSInteger, RFViewControllerState) {
    RFViewControllerStateNone = 0,
    RFViewControllerStateWillAppear,
    RFViewControllerStateDidAppear,
    RFViewControllerStateWillDisappear,
    RFViewControllerStateDidDisappear,
};
...
@property (nonatomic) RFViewControllerState state;
...
+ (instancetype)controllerFromNib
{
    ...
    return [RFNibUtil loadMainObjectFromNib:nibName];
}
...
- (void)viewDidLoad
{
    ...
    self.state = RFViewControllerStateNone;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (self.state == RFViewControllerStateWillAppear || self.state == RFViewControllerStateDidAppear) {
        return;
    }
    self.state = RFViewControllerStateWillAppear;
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (self.state == RFViewControllerStateDidAppear) {
        return;
    }
    self.state = RFViewControllerStateDidAppear;
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    if (self.state == RFViewControllerStateNone || self.state == RFViewControllerStateDidDisappear || self.state == RFViewControllerStateWillDisappear) {
        return;
    }
    
    self.state = RFViewControllerStateWillDisappear;
...
- (void)viewDidDisappear:(BOOL)animated
{
    ...
    if (self.state == RFViewControllerStateNone || self.state == RFViewControllerStateDidDisappear) {
        return;
    }
    self.state = RFViewControllerStateDidDisappear;
}
...
- (BOOL)isViewAppeared
{
    return self.state == RFViewControllerStateDidAppear;
}
