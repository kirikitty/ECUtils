...
@interface RFTextToast : ECToast

@property (weak, nonatomic) UILabel *textLabel;

- (instancetype)initWithText:(NSString *)text style:(ECToastStyle)style;

@end

@interface RFLoadingToast : ECToast
...
- (void)prepareWithText:(NSString *)text style:(ECToastStyle)style block:(BOOL)block;

@end

@implementation ECToast
...
+ (void)showTextWithFormat:(NSString *)fmt, ...
{
    ...
    va_end(args);
    [self showText:text style:ECToastStyleLightContent];
}
...
{
    ECToast *toast = [[RFTextToast alloc] initWithText:text style:style];
    [toast show];
...
{
    [self showLoadingWithText:text style:ECToastStyleLightContent];
}
...
+ (void)showLoadingWithText:(NSString *)text style:(ECToastStyle)style block:(BOOL)block
{
...
+ (void)showLoading
{
    [self showLoadingWithText:nil style:ECToastStyleDefault];
}
