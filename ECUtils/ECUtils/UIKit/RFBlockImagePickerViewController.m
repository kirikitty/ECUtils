//
//  RFBlockImagePickerViewController.m
//  ECUtils
//
...
@interface RFBlockImagePickerViewController () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation RFBlockImagePickerViewController
